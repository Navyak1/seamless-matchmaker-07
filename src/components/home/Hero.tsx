  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute bottom-1/3 right-1/4 w-96 h-96 bg-accent/5 rounded-full filter blur-3xl"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-24 flex flex-col items-center text-center z-10">
        ...
        <h1 className="text-4xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/70 leading-tight max-w-4xl animate-fade-in" style={{ animationDelay: '0.4s' }}>
          Seamless Matchmaking for the Modern Gamer
        </h1>
        
        <p className="mt-6 text-lg md:text-xl text-muted-foreground max-w-2xl animate-fade-in" style={{ animationDelay: '0.6s' }}>
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-4xl animate-fade-in" style={{ animationDelay: '1s' }}>
          <div className="frosted rounded-2xl p-6 hover-scale">
            <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center mb-4">
              <Users className="h-6 w-6 text-primary" />
            </div>
            <h3 className="text-lg font-medium mb-2">Auto-Matchmaking</h3>
            <p className="text-muted-foreground text-sm">Instantly pair with players of similar skill level</p>
          </div>
          ...
          <div className="frosted rounded-2xl p-6 hover-scale">
            ...
            <p className="text-muted-foreground text-sm">Create private games and invite your friends</p>
          </div>
          ...
          <div className="frosted rounded-2xl p-6 hover-scale">
            ...
            <p className="text-muted-foreground text-sm">No complicated setups or downloads required</p>
          </div>
        </div>
      </div>
    </section>
